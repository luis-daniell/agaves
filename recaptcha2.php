...
// Verifica el correcto formato de email
    ...
    if($arrResponse['success'] && ($arrResponse['score'] && $arrResponse['score'] > 0.5))
    {
      ...
      echo "<div style='background-color: rgb(241 245 249); margin-top: 10px; width: 75%;'><p style ='color: green; font-weight: 400;'>The email has been sent successfully</p> </div>";
      
    }

    else
    {
      echo "<div style='background-color:  rgb(241 245 249); margin-top: 10px; width: 75%;'><p style ='color: red; font-weight: 400;'>Error! Email could not be sent</p> </div>";
